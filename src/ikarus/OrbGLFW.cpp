...
{
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_SPECIAL] = 0;
	...
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F13] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F14] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F15] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F16] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F17] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F18] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F19] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F20] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F21] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F22] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F23] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F24] = 0;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_F25] = 0;
	...
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_LSHIFT] = KeyCode::LeftShift;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_RSHIFT] = KeyCode::RightShift;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_LCTRL] = KeyCode::LeftCtrl;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_RCTRL] = KeyCode::RightCtrl;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_LALT] = KeyCode::LeftAlt;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_RALT] = KeyCode::RightAlt;
	...
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_KP_DECIMAL] = KeyCode::NumPadDot;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_KP_EQUAL] = 0;
	...
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_LSUPER] = KeyCode::LeftWin;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_RSUPER] = KeyCode::RightWin;
	GLFW_KEY_TO_ORB_KEY[GLFW_KEY_MENU] = KeyCode::RightMenu;
}
